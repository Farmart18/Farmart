...
//                                let farmer = try await AuthManager.shared.signInWithGoogleUsingSafari()
                        ...
                        Task {
                            ...
                            do {
                               ...
                               let farmer = try await authManager.signInWithGoogle(idToken: result.idToken)
                                ...
                                //let (idToken, nonce) = try await signInGoogle.startSignInWithGoogleFlow()
                                //let farmer = try await AuthManager.shared.signInWithGoogle(idToken: idToken)
                               //print("🚀 Signed in as: \(farmer.name)")
                                isLoggedIn = true
                            } catch {
                                print("🚀 Sign-in failed: \(error)")
